          ...
          <div class="exchange-form">
          	...
          	<div class="rel">
	          	<div class="flex flex-between left">
		          	<a href="#from" class="from-name bk hide-link drop"><?=$data->from['paypal']['name']?></a>
		          	<div class="from-code"><?=$data->from['paypal']['code']?></div>
		          </div>
	          ...
	          <div class="rel">
		          <div class="flex flex-between left">
		          	<a href="#to" class="to-name bk hide-link drop"><?=$data->to['ves']['name']?></a>
		          	<div class="to-code"><?=$data->to['ves']['code']?></div>
		          </div>
